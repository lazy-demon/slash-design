...
CREATE TABLE "serverpod_readwrite_test" ("id" serial, "number" integer NOT NULL);
...
ALTER TABLE ONLY "serverpod_query_log"
ADD CONSTRAINT serverpod_query_log_fk_0 FOREIGN KEY("sessionLogId") REFERENCES serverpod_session_log(id) ON DELETE CASCADE;
--
...
ALTER TABLE ONLY "serverpod_message_log"
ADD CONSTRAINT serverpod_message_log_fk_0 FOREIGN KEY("sessionLogId") REFERENCES serverpod_session_log(id) ON DELETE CASCADE;
--
...
ALTER TABLE ONLY "serverpod_log"
ADD CONSTRAINT serverpod_log_fk_0 FOREIGN KEY("sessionLogId") REFERENCES serverpod_session_log(id) ON DELETE CASCADE;